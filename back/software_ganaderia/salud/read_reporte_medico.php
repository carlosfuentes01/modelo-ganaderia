    ...
    <div id="BarraLateral">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                ...
                <li>
                    <a href="#" class="nav-link active text-white"><i class="fa-solid fa-clipboard-check" style="color: #ff0000;"></i>  GESTIONAR REPORTES MEDICOS</a>
    ...
    <div id="navbar">
            ...
            <div class="modal fade" id="ModalRegistrar" tabindex="-1" aria-labelledby="exampleModalLabel"
              ...
              Tratamiento: {$tratamiento['tipo']} - Enfermedad: {$tratamiento['enfermedad']}<br>";
                        ...
                        <table id="example" class="mdl-data-table" style="width:100%">
                            ...
                            <thead>
                                <tr>
                                    <th><i class="fa-solid fa-hat-cowboy" style="color: #00bd52;"></i> Vaca (Identificación)</th>
                                    <th><i class="fa-solid fa-seedling" style="color: #00bd52;"></i>  Nombre de la Vaca</th>
                                    <th><i class="fa-regular fa-calendar-days" style="color: #00bd52;"></i>  Fecha de Chequeo</th>
                                    <th><i class="fa-regular fa-calendar-days" style="color: #00bd52;"></i>  Fecha Próximo Chequeo</th>
                                    <th><i class="fa-solid fa-notes-medical" style="color: #00bd52;"></i>  Notas Adicionales</th>
                                    <th><i class="fa-solid fa-clipboard-question" style="color: #00bd52;">  </i>¿Está Preñada?</th>
                                    <th><i class="fa-regular fa-clipboard" style="color: #00bd52;"></i>  Tratamientos y Enfermedades</th>
        ...
        ";
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-primary" onclick="Editar('<?= $row['reporte_id'] ?>')"><i class="fa-regular fa-pen-to-square" style="color: #00bd52;"></i>  Editar</button>

                                        </td>
                                        <td>
                                            <button class="btn btn-danger" onclick="Borrar('<?= $row['reporte_id'] ?>')"><i class="fa-solid fa-trash" style="color: #00bd52;"></i>  Eliminar</button>
                                        </td>
                                    </tr>
                                <?php
                                }
