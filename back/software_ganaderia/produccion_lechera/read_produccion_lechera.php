...
WHERE finca.usuario_dni = $sesion";
    ...
    <div id="BarraLateral">
        <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark sidebar">
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="../produccion_lechera/read_produccion_lechera.php" class="nav-link active text-white" aria-current="page"><i class="fa-solid fa-clipboard-check" style="color: #ff0000;"></i> GESTIONAR LECHE</a>
                </li>
                <li>
    ...
    <div id="BloqueContenedor">
        ...
        <div class="CentrarBoton">
            ...
            <div class="modal fade" id="ModalRegistrar" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollableg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Registrar Leche</h5>
                ...
                window.location.href='./read_produccion_lechera.php';
                            ...
                            <form style="width: 100%;" method="POST" id="cre" action="../produccion_lechera/read_produccion_lechera.php">
                                Litros producidos: <input type="number" style="width: 100%;" name="litros" step="0.01" required><br>
                                Fecha de producción: <input type="date" style="width: 100%;" name="fecha" required><br>

                                Vaca:
                                <select style="width: 100%;" name="vaca_id">
                                    <?php
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" onclick="cr()" class="btn btn-primary">Registrar leche</button>
                        </div>
                        <script>
                            function cr() {
        ...
        ?>
            <table id="example" class="mdl-data-table" style="width:100%">
                <thead>
                    <tr>
                        <th><i class="fa-solid fa-droplet" style="color: #00bd52;"></i> <b>Litros de leche</b></th>

                        <th><i class="fa-solid fa-calendar" style="color: #00bd52;"></i> <b>Fecha</b></th>
                        <th><i class="fa-solid fa-cow" style="color: #00bd52;"></i> <b>Vaca</b></th>
                        <th><i class="fa-solid fa-house-flag" style="color: #00bd52;"></i><b> Potrero</b></th>
                        <th><i class="fa-solid fa-code-merge" style="color: #00bd52;"></i> <b>Finca</b></th>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-primary" onclick="Editar('<?= $row['id_produccion'] ?>')"><i class="fa-regular fa-pen-to-square" style="color: #00bd52;"></i> Editar</button>


                            </td>
                            <td>
                                <button class="btn btn-danger" onclick="Borrar('<?= $row['id_produccion'] ?>')"><i class="fa-solid fa-trash" style="color: #00bd52;"></i> Eliminar</button>
                            </td>
                        </tr>
                    <?php
                    }
    ...
    <script>
        function Editar(id) {
            ...
            $.ajax({
                data: parametros,
                url: '../../ajax/produccion_lechera/ModalEditar.php',
                type: 'POST',
        ...
        function Borrar(id) {
            ...
            $.ajax({
                data: parametros,
                url: '../../ajax/produccion_lechera/ModalBorrar.php',
                type: 'POST',
